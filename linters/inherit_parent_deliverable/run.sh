...
#
# Usage: ./inherit_parent_deliverable/run.sh <issue-url> --dry-run --project-number <project-number>
...
issue_url=""
project_number=18
script_dir="./linters/inherit_parent_deliverable"
...
parent_project_item=$(pluck_field "$data" ".parent.projectItems.nodes[] | select(.deliverable != null and .project.number == $project_number)")
